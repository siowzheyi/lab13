...
public class ClientDateFrame extends JFrame {
	...
	/**
	 * This method update the value of data on the frame
	 * 
	 * @param numberText: text's length
	 * @author Siow Zhe Yi
	 */
	public void updateServerText (String numberText) {
		
		this.lblServerDate.setText(numberText);
	...
	private JPanel getServerDatePanel(Font font) {
		...
		JPanel panel = new JPanel();
		JLabel lblDate = new JLabel ("Data (from Server): ");
